...
- This is a composite GitHub Action that embeds Python logic directly in
  action.yml.
- All changes to protobuf release logic should be made in the embedded Python
...
This repository provides a composite GitHub Action that generates and releases
protobuf artifacts.
