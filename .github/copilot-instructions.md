...
<!-- version: 1.1.0 -->
<!-- guid: d0e1f2a3-b4c5-6789-d567-890123456789 -->
...
- All changes to protobuf release logic should be made in the embedded Python script within action.yml.
...
This repository provides a composite GitHub Action that generates and releases protobuf artifacts.
